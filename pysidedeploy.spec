...
input_file = src/pyzza/pyside_app/main.py

# directory where the executable output is generated
exec_directory = build/pyside
...
# python path
python_path = /home/kgd/.pyenv/versions/3.12.8/envs/venv-pyzza-flet/bin/python
...
extra_args = --quiet --noinclude-qt-translations --static-libpython=no --include-package=pyzza.misc --include-package=pyzza.models --include-package=pyzza.networking
